...
const Pager = ({changePageNumber,pageNum}) => {
  return (
    ...
    <ul class="pagination">
    <li class="page-item"><button onClick={()=>changePageNumber(pageNum-1)}   class="page-link" >Previous</button></li>
    ...
    <li class="page-item"><button class="page-link"  onClick={()=>changePageNumber(pageNum+1)} >Next</button></li>
  </ul>
</nav>
    </div>
  )
